...
copy switches(id, title, file_name)
...
create index on box_types(id);
copy keyboards(owner_id, switch_type_id, box_type_id, title, file_name, creation_date)
...
copy boxes(owner_id, type_id, title, file_name, creation_date)
...
copy kits(id, owner_id, box_type_id, title, preview_name, creation_date)
...
copy keycaps(kit_id, title, file_name, creation_date)
