...
from '/postgres/main/init/users.csv'
delimiter ','
csv header;
...
from '/postgres/main/init/switches.csv'
delimiter ','
csv header;
...
from '/postgres/main/init/box_types.csv'
delimiter ','
csv header;
...
from '/postgres/main/init/keyboards.csv'
delimiter ','
csv header;
...
from '/postgres/main/init/boxes.csv'
delimiter ','
csv header;
...
from '/postgres/main/init/kits.csv'
delimiter ','
csv header;
...
from '/postgres/main/init/keycaps.csv'
delimiter ','
csv header;