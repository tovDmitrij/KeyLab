...
namespace api.v1.main.Services.User
{
    public sealed class UserService : IUserService
    {
        ...
        public UserService(IUserRepository user, IVerificationRepository verification, IUserRegexHelper rgx, 
                           ...
                           IJWTConfigurationHelper cfgJWT, IEmailService email, IFileConfigurationHelper cfgFile)
        {
            _user = user;
        ...
        public SignInDTO SignIn(PostSignInDTO body)
        {
            ...
            _email.SendEmail(new(body.Email, _localization.UserSignInEmailLabel(), _localization.UserSignInEmailText()));
